...
PANEL_HW_SOURCE_Visu=C:/Users/admin/Desktop/Souls/lab3/Physical/Config1/Hardware.hw 
...
PAGE_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/Visu/Pages/Control.page \
	$(AS_PROJECT_PATH)/Logical/Visu/Pages/Graphic.page \
	$(AS_PROJECT_PATH)/Logical/Visu/Pages/Diods.page \
	$(AS_PROJECT_PATH)/Logical/Visu/Pages/aHome.page 
...
$(TEMP_PATH_Visu)/page.Control.vco: $(AS_PROJECT_PATH)/Logical/Visu/Pages/Control.page $(VC_LANGUAGES_Visu)
...
$(TEMP_PATH_Visu)/page.Graphic.vco: $(AS_PROJECT_PATH)/Logical/Visu/Pages/Graphic.page $(VC_LANGUAGES_Visu)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu) -P '$(AS_PROJECT_PATH)' -ds '$(SRC_PATH_Visu)/StyleSheets/Color.vcs' -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas


$(TEMP_PATH_Visu)/page.Diods.vco: $(AS_PROJECT_PATH)/Logical/Visu/Pages/Diods.page $(VC_LANGUAGES_Visu)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu) -P '$(AS_PROJECT_PATH)' -ds '$(SRC_PATH_Visu)/StyleSheets/Color.vcs' -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas


$(TEMP_PATH_Visu)/page.aHome.vco: $(AS_PROJECT_PATH)/Logical/Visu/Pages/aHome.page $(VC_LANGUAGES_Visu)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu) -P '$(AS_PROJECT_PATH)' -ds '$(SRC_PATH_Visu)/StyleSheets/Color.vcs' -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas
...
$(TEMP_PATH_Visu)/tpr.NumPad.vco: $(AS_PROJECT_PATH)/Logical/Visu/TouchPads/NumPad.tpr
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu) -prj 'C:/Users/admin/Desktop/Souls/lab3/Logical/Visu' -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas
